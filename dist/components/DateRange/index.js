...
var DateRange = /*#__PURE__*/function (_Component) {
  ...
  function DateRange(props, context) {
    ...
    _defineProperty(_assertThisInitialized(_this), "calcNewSelection", function (value) {
      ...
      var startTime = (0, _utils.getTime)(startDate);
      var endTime = (0, _utils.getTime)(endDate);
      var now = new Date();
      var nextFocusRange;
      ...
      if (!isSingleValue) {
        ...
        if (!onlyDate) startTime = (0, _utils.getTime)(value);
        startDate = value;
        endDate = calculateEndDate();
        if (maxDate) endDate = (0, _min.default)([(0, _utils.setTime)(endDate, endTime), maxDate]);
        nextFocusRange = [focusedRange[0], 1];
      } else {
        if (!onlyDate) endTime = (0, _utils.getTime)(value);
        endDate = value;
      ...
      if ((0, _isBefore.default)((0, _utils.setTime)(endDate, endTime), (0, _utils.setTime)(startDate, startTime))) {
      ...
      startDate = (0, _utils.setTime)(startDate, startTime);
      endDate = (0, _utils.setTime)(endDate, endTime);
      return {
    ...
    _defineProperty(_assertThisInitialized(_this), "setSelection", function (value, isSingleValue) {
      ...
      var newSelection = _this.calcNewSelection(value, isSingleValue, onlyDate);
  ...
  _createClass(DateRange, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/_react.default.createElement(_Calendar.default, _extends({
        ...
        onChange: function onChange(val, onlyDate) {
          return _this2.setSelection(val, true, onlyDate);
        },
