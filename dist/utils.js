...
exports.dateFormatContainsTime = dateFormatContainsTime;
...
function getTime(date) {
  return {
    hours: (0, _getHours.default)(date),
    minutes: (0, _getMinutes.default)(date),
    seconds: (0, _getSeconds.default)(date)
  };
}

function setTime(date, _ref) {
  var hours = _ref.hours,
      minutes = _ref.minutes,
      seconds = _ref.seconds;
  return (0, _setHours.default)((0, _setMinutes.default)((0, _setSeconds.default)(date, seconds), minutes), hours);
}

function dateFormatContainsTime(date_format) {
  /* eslint-disable prettier/prettier */
  return ['h', 'ho', 'hh', 'H', 'Ho', 'HH', 'K', 'Ko', 'KK', 'k', 'ko', 'kk', 'm', 'mo', 'mm', 'p', 'pp', 'ppp', 'pppp', 'Pp', 'PPpp', 'PPPppp', 'PPPPpppp'].some(function (format) {
    return date_format.includes(format);
  });
  /* eslint-enable */
}
